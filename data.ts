...
export const languages:ISkill[]=[
  ...
  {
    Icon:AiFillCheckCircle,
    name:'React & ReactNative &  TSX/JSX',
    level:'81%',
  },
  {
    Icon:AiFillCheckCircle,
    name:'NextJS & Redux & Redux-Toolkit',
    level:'78%',
  },
  {
    Icon:AiFillCheckCircle,
    name:'Tailwind & Bootstrap & Material-ui',
    level:'95%',
  },
...
export const projects:IProject[]=[
  {
    id:1,
    name:"Night Movie",
    descriptions:"The worlds latest movie and series site with various features, and It has a great UX & UI",
  ...
  },
  {
    id:2,
    name:"Blug Hub",
    descriptions:"The site of all kinds of articles about the world of technology and all kinds of famous authors with the ability to leave comments",
  ...
  },
  {
    id:3,
    name:"Dalla App",
    descriptions:"Most of it has a strong UX & UI and the purpose of making it is the same with registration and email capabilities",
